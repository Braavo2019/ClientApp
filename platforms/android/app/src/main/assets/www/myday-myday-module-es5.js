...
var MdRowComponent = /** @class */ (function () {
    function MdRowComponent() {
    }
    MdRowComponent.prototype.ngOnInit = function () { };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
...
var MydayPageRoutingModule = /** @class */ (function () {
    function MydayPageRoutingModule() {
    }
...
var MydayPageModule = /** @class */ (function () {
    function MydayPageModule() {
    }
...
var MydayPage = /** @class */ (function () {
    function MydayPage(api) {
        var _this = this;
        this.api = api;
        this.products = [];
        ...
        console.log("Init1");
        api.selectedMeal.subscribe(function (value) {
            _this.selectedMeal = value;
        });
        this.getProductsFromServer();
    }
    MydayPage.prototype.ionViewWillEnter = function () {
        console.log("INIT2");
        this.selectedMeal = false;
    };
    MydayPage.prototype.ionViewDidEnter = function () {
        console.log("INIT23");
        this.selectedMeal = false;
    };
    MydayPage.prototype.ngOnInit = function () {
        console.log("Init");
        this.selectedMeal = false;
    };
    MydayPage.prototype.getProductsFromServer = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.api.getMyDayProduct()];
                    case 1:
                        _a.products = _b.sent();
    ...
    MydayPage.prototype.openCloseMealPage = function (item) {
        console.log("openMealPage : ", item);
        if ((item && item['type'] == "Meal") || !item)
            this.selectedMeal = !this.selectedMeal;
    };
    MydayPage.prototype.refreshMeal = function () {
        this.api.selectedMealRefresh.next(true);
        console.log("R2");
    };
    MydayPage.prototype.ionSelected = function () {
        console.log("Home Page has been selected");
        // do your stuff here
    };
    MydayPage.prototype.goToPrefrences = function () {
    };
    MydayPage.prototype.changeSelectedMeal = function () {
        this.selectedMeal = !this.selectedMeal;
    };
    MydayPage.ctorParameters = function () { return [
...
var SelectedMealComponent = /** @class */ (function () {
    function SelectedMealComponent(api) {
        var _this = this;
        this.api = api;
        this.slideOptsTwo = {
            initialSlide: 1,
        ...
        api.selectedMealRefresh.subscribe(function (value) {
            _this.getMeals();
        });
        this.getMeals();
    }
    SelectedMealComponent.prototype.getMeals = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.api.getMeals()];
                    case 1:
                        _a.meals = _b.sent();
                        this.meals.map(function (ob) {
                            if (ob['MealType'] == 10)
                                _this.mealsObj.Breakfest = ob;
                            if (ob['MealType'] == 20)
                                _this.mealsObj.Lunch = ob;
                            if (ob['MealType'] == 30)
                                _this.mealsObj.Dinner = ob;
                        });
    ...
    //Move to Next slide
    SelectedMealComponent.prototype.slideNext = function (object, slideView) {
        var _this = this;
    ...
    SelectedMealComponent.prototype.slidePrev = function (object, slideView) {
        var _this = this;
    ...
    SelectedMealComponent.prototype.SlideDidChange = function (object, slideView) {
        this.checkIfNavDisabled(object, slideView);
    };
    //Call methods to check if slide is first or last to enable disbale navigation  
    SelectedMealComponent.prototype.checkIfNavDisabled = function (object, slideView) {
        this.checkisBeginning(object, slideView);
        this.checkisEnd(object, slideView);
    };
    SelectedMealComponent.prototype.checkisBeginning = function (object, slideView) {
        slideView.isBeginning().then(function (istrue) {
            object.isBeginningSlide = istrue;
        });
    };
    SelectedMealComponent.prototype.checkisEnd = function (object, slideView) {
        slideView.isEnd().then(function (istrue) {
            object.isEndSlide = istrue;
        });
    };
    SelectedMealComponent.prototype.shuffle = function (a) {
        var _a;
...
//# sourceMappingURL=myday-myday-module-es5.js.map