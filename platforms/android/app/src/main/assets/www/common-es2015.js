...
let MarketHeaderComponent = class MarketHeaderComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() { }
...
MarketHeaderComponent.ctorParameters = () => [
        ...
        return new Promise((resolve, reject) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                ...
                if (yield this.settings.checkIsNetwork())
                    yield this.http.post(this.globalURL + '/PatientSettings/get', ob).subscribe(data => { console.log("ID : ", data); resolve(data); });
                else
                    yield this.http.get(this.baseURL + 'patient.json').subscribe(data => { console.log(data); resolve(data); });
            }
            catch (err) {
                console.log(err);
            }
...
let GlobalService = class GlobalService {
    constructor(platform, network) {
        ...
        this.globalURL = "http://www.braavolife.com/api/";
...
GlobalService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"], _ionic_native_network_ngx__WEBPACK_IMPORTED_MODULE_3__["Network"]])
], GlobalService);
