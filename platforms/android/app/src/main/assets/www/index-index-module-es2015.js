...
let ApiIndexService = class ApiIndexService {
    ...
    getIndex() {
        return new Promise((resolve, reject) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                yield this.http.get(this.baseURL + 'index.json').subscribe(data => { console.log(data); resolve(data); });
            }
            catch (err) {
                console.log(err);
            }
...
ApiIndexService.ctorParameters = () => [
...
let IndexPage = class IndexPage {
    ...
    getMainIndex() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.mainIndex = yield this.api.getIndex();
