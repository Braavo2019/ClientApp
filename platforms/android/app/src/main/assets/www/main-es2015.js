...
const routes = [
    ...
    {
        path: 'prefrences/:id',
        loadChildren: () => Promise.all(/*! import() | pages-prefrences-prefrences-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-prefrences-prefrences-module")]).then(__webpack_require__.bind(null, /*! ./pages/prefrences/prefrences.module */ "./src/app/pages/prefrences/prefrences.module.ts")).then(m => m.PrefrencesPageModule)
    },
    {
        path: 'user-details',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-user-details-user-details-module */ "pages-user-details-user-details-module").then(__webpack_require__.bind(null, /*! ./pages/user-details/user-details.module */ "./src/app/pages/user-details/user-details.module.ts")).then(m => m.UserDetailsPageModule)
    },
    {
        path: 'login',
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() | pages-network-details-network-details-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-network-details-network-details-module")]).then(__webpack_require__.bind(null, /*! ./pages/network-details/network-details.module */ "./src/app/pages/network-details/network-details.module.ts")).then(m => m.NetworkDetailsPageModule)
    },
    {
        path: 'index',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-index-index-module */ "index-index-module").then(__webpack_require__.bind(null, /*! ./pages/index/index.module */ "./src/app/pages/index/index.module.ts")).then(m => m.IndexPageModule)
    }
];
